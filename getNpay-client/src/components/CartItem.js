    ...
    try {
      for (let rfid of rfidList) {
        ...
        querySnapshot.forEach((doc) => {
          ...
          const hasAllRfidTags = product.RFIDnum.every(tag => rfidList.includes(tag));
          const notAddedYet = !productsWithRfid.some(existingProduct => existingProduct.id === product.id);
